...
На основании этих документов менеджер расчитает вам страховку с учетом скидки или кешбэка.`
	GET string = `Есть файлы от следующих клиентов.
Выберите нужного вам.`
	LIST_FILES string = `Файлы от клиента @%s.
Выберите нужный вам.`
...
`
	...
	WRONG_SYS           string = "Произошел сбой в системе. Повторите запрос."
)
